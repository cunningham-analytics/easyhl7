{% macro config_v2_6_RDE_O11() %}
    ...
    {% set config = {
        ...
        "children": [
            ...
            {
                "type":"group","name":"PATIENT","min":0,"max":1,
                "anchor":"PID",
                "children":[
                    ...
                    {"type":"segment","name":"NTE","min":0,"max":none},
                    {
                        "type":"group","name":"PATIENT_VISIT","min":0,"max":1,
                        "anchor":"PV1",
                        "children":[
                    ...
                    {
                        "type":"group","name":"INSURANCE","min":0,"max":none,
                        "anchor":"IN1",
                        "children":[
            ...
            {
                "type":"group","name":"ORDER","min":1,"max":none,
                "anchor":"ORC",
                "children":[
                    {"type":"segment","name":"ORC","min":1,"max":1},
                    {
                        "type":"group","name":"TIMING","min":0,"max":none,
                        "anchor":"TQ1",
                        "children":[
                    ...
                    {
                        "type":"group","name":"ORDER_DETAIL","min":0,"max":1,
                        "anchor":"RXO",
                        "children":[
                            ...
                            {
                                "type":"group","name":"COMPONENT","min":0,"max":none,
                                "anchor":"RXC",
                                "children":[
                    ...
                    {"type":"segment","name":"NTE","min":0,"max":none},
                    {
                        "type":"group","name":"TIMING_ENCODED","min":1,"max":none,
                        "anchor":"TQ1",
                        "children":[
                            {"type":"segment","name":"TQ1","min":1,"max":1},
                            {"type":"segment","name":"TQ2","min":0,"max":none}
